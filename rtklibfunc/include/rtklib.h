...
typedef struct {                      /* observation data record */
  ...
  double rs[6];             // 卫星位置
  int phasebreak;           // 周跳或新卫星
  double newBias;           // 新的模糊度
  double Range, RangeRes, RangeWeight;
  double Phase, PhaseRes, PhaseWeight;
} obsd_t;
...
EXPORT int satpos(gtime_t time, gtime_t teph, int sat, int ephopt,
                  ...
                  int *svh);
EXPORT void satposs(gtime_t time, obsd_t *obs, int n, const nav_t *nav,
...
EXPORT void estvel(const obsd_t *obs, int n, const double *rs,
                   const double *dts, const nav_t *nav, const prcopt_t *opt,
                   sol_t *sol, const double *azel, const int *vsat);
EXPORT int raim_fde(const obsd_t *obs, int *ntemp, const double *rs,
