...
static int ppp_res(int post, const obsd_t *obs, int n, const double *rs,
  ...
  /*if (!post)
  {
          double spp_x[4];
          int m;
          for (m = 0; m < 3; m++) spp_x[m] = rr[m]; spp_x[3] = x[3];
          trace(6, "spp_x:"); tracemat(6, spp_x, 1, 4, 12, 3);
  }*/
  ecef2pos(rr, pos);
  ...
  for (i = 0; i < n && i < MAXOBS; i++) {
    ...
    for (j = 0; j < 2 * NF(opt); j++) {
      ...
      // if (post)
      // {
      // 	double Dts = CLIGHT * dts[i * 2], Dion = C * dion;
      // 	trace(6, "G%2d-%s:\n", sat, j % 2 == 0 ? "L" : "P");
      // 	trace(6, "v[%d]:", nv); tracemat(6, v + nv, 1, 1, 12, 3);
      // 	trace(6, "y:"); tracemat(6, &y, 1, 1, 12, 3);
      // 	trace(6, "r:"); tracemat(6, &r, 1, 1, 12, 3);
      // 	trace(6, "cdtr:"); tracemat(6, &cdtr, 1, 1, 5, 3);
      // 	trace(6, "cdtsys"); tracemat(6, &cdtsys, 1, 1, 5, 3);
      // 	trace(6, "Dts:"); tracemat(6, &Dts, 1, 1, 5, 3);
      // 	trace(6, "dtrp:"); tracemat(6, &dtrp, 1, 1, 5, 3);
      // 	trace(6, "Dion:"); tracemat(6, &Dion, 1, 1, 5, 3);
      // 	trace(6, "grav_delay:");
      // 	tracemat(6, &grav_delay, 1, 1, 5, 3);
      // 	trace(6, "dcb:"); tracemat(6, &dcb, 1, 1, 5, 3);
      // 	trace(6, "bias:"); tracemat(6, &bias, 1, 1, 5, 3);
      // 	trace(6, "\n:");
      // }
  ...
  // if(post==0)trace(6, "\nPPP residuals at %s:\n", str);
  ////trace(7, "x=\n"); tracemat(7, x, 1, nx, 8, 3);
  // trace(6, "v%d=\n",post); tracemat(6, v, 2, nv/2, 8, 3);
  // if (post == 9) trace(7, "\n\n\n");
  // trace(7, "R=\n"); tracemat(7, R, nv, nv, 8, 5);
...
extern void pppos(rtk_t *rtk, const obsd_t *obs, int n, const nav_t *nav) {
  ...
  double sow = time2gpst(obs[0].time, NULL);
  double ep[6];
