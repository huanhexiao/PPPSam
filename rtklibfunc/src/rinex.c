...
static int addobsdata(obs_t *obs, const obsd_t *data) {
  ...
  obs->data[obs->n].phasebreak = 0;
  obs->data[obs->n].newBias = 0;
  obs->data[obs->n].Range = 0;
  obs->data[obs->n].RangeRes = 0;
  obs->data[obs->n].RangeWeight = 0;
  obs->data[obs->n].Phase = 0;
  obs->data[obs->n].PhaseRes = 0;
  obs->data[obs->n].PhaseWeight = 0;
