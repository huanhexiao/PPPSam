...
static const char rcsid[] =
    "$Id: lambda.c,v 1.1 2008/07/17 21:48:06 ttaka Exp $";
...
static int search(int n, int m, const double *L, const double *D,
  ...
  double *S = zeros(n, n), *dist = mat(n, 1), *zb = mat(n, 1), *z = mat(n, 1),
         *step = mat(n, 1);
...
extern int lambda(int n, int m, const double *a, const double *Q, double *F,
  ...
  /* LD factorization */
  if (!(info = LD(n, Q, L, D))) {
    /*trace(6, "Qa's factor L=\n"); tracemat(6, L, n, n, 11, 8);
    trace(6, "Qa's factor D=\n"); tracemat(6, D, n, 1, 11, 8);
    trace(6, "float ambiguity a=\n"); tracemat(6, a, n, 1, 11, 8);*/
